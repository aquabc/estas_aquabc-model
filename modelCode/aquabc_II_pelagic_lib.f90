!--------------------------------------------------------------------------
!
!    Copyright (C) 2011-2019  Ali Erturk  
!    Copyright (C) 2011-2019  Petras Zemlys     
!
...
!
    ...
    if (smith .eq. 1) then
         ...
         call LIM_LIGHT(I_A, CHLA, KG_FIX_CYN, DEPTH, K_E, LIM_KG_FIX_CYN_LIGHT, FIX_CYN_C_TO_CHLA, &
                                                         I_S_FIX_CYN, FIX_CYN_LIGHT_SAT,nkn)
...
!    print *, '*KG_NOST_VEG_HET         :',        KG_NOST_VEG_HET
!    print *, '*R_NOST_VEG_HET_GROWTH  :',         R_NOST_VEG_HET_GROWTH
!    print *, '*R_NOST_VEG_HET_NON_FIX_GROWTH',    R_NOST_VEG_HET_NON_FIX_GROWTH
!    print *, '*R_NOST_VEG_HET_FIX_GROWTH:',       R_NOST_VEG_HET_FIX_GROWTH
!    print *, '*TEMP:',                            TEMP
!    print *, '*LIM_KG_NOST_VEG_HET_FIX:',         LIM_KG_NOST_VEG_HET_FIX
!    print *, '*LIM_KG_NOST_VEG_HET_NON_FIX:',     LIM_KG_NOST_VEG_HET_NON_FIX
!    print *, '*LIM_KG_NOST_VEG_HET_LIGHT',    LIM_KG_NOST_VEG_HET_LIGHT     
!    print *, '*LIM_KG_NOST_VEG_HET_TEMP ',    LIM_KG_NOST_VEG_HET_TEMP      
!    print *, '*LIM_KG_NOST_VEG_HET_DOXY ',    LIM_KG_NOST_VEG_HET_DOXY      
!    print *, '*LIM_KG_NOST_VEG_HET_N    ',    LIM_KG_NOST_VEG_HET_N         
!    print *, '*LIM_KG_NOST_VEG_HET_P    ',    LIM_KG_NOST_VEG_HET_P    
!    print *, '*NOST_VEG_HET_C:',     NOST_VEG_HET_C
!    print *, '*AKI_GERM:',       AKI_GERM
